...
- use  NOTEit personally on your own devices

- use  NOTEit for hobby projects

- use  NOTEit for educational or learning purposes

- use  NOTEit for indie and non-commercial creative workflows

- study the source code

- modify the source code for your own private, non-commercial, educational, hobbyist, or indie workflow

- fork, clone, or copy the repository for non-commercial development and experimentation

- share unmodified or modified copies for non-commercial purposes only, provided proper attribution is given and this license remains included
...
- keep this license file included

- clearly indicate whether you changed the project

- not misrepresent the project as your own original work

- not remove existing copyright, attribution, author, branding, or license notices

- not remove attribution comments from source files unless you have written permission

- make clear that unofficial modifications, forks or builds are not the original project unless explicitly approved
...
- sell a modified version of  NOTEit

- commercially redistribute  NOTEit

- commercially sublicense  NOTEit

- rebrand  NOTEit as your own commercial software

- include  NOTEit in a paid software package, paid marketplace product, paid app bundle, paid hosting package, paid media service, paid web service or paid SaaS service

- offer  NOTEit as part of a commercial toolchain, managed service, kiosk product, media appliance, app collection or commercial support package

- use the  NOTEit repository, source code, project structure, interface, branding, logo or modified builds as the basis for a commercial competing product

- claim authorship of the original  NOTEit project

- remove or hide original attribution notices
...
- artwork extraction correctness
